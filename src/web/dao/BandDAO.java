...
public class BandDAO{
	...
	/**
	 * Funci�n que se encarga de actualiza en la BBDD el atributo informaci�n de la banda
	...
	/**
	 * Funci�n que se encarga de hacer una b�squeda en la BBDD sobre las bandas que cumplen
	 * con la keyWord introducida como par�metro.
	 *  
