...
/**
 * Clase que implementa un patr贸n de acceso a BBDD de tipo Table Data Gateway,
 * en este caso, para la tabla de la BBDD que almacena los datos de un usuario
 * de tipo banda.
 */
public class BandDAO {
	/**
	 * Funci贸n que se encarga de insertar los datos de una banda en la BBDD, incluidos los
	 ...
	 * Si no puede insertarlos lanza una excepci贸n.
	 * 
	 * @param b Objeto de tipo BandVO que contiene la informaci贸n de un usuario
	...
	/**
	 * Funci贸n que se encarga de comprobar si el email de la banda introducido
	 ...
	 * en la BBDD y false si no est谩 almacenada en esta.
	 */
	...
	/**
	 * Funci贸n que se encarga de realizar la query a la base de datos que 
	 * permiete obtener todos los generos m煤sicales almacenador en esta.
	 * 
	...
	/**
	 * Funci贸n que se encarga de buscar en la base de datos los datos del usuario de
	 * tipo banda que se identifican a partir del email introducido como par谩metro
	 * en la funci贸n.
	 * 
	 * @param email Cadena de caracteres que identifica al usuario de tipo 
	 * banda a buscar.
	 * @return Objeto de tipo FanVO con toda la informaci贸n almacenada sobre
	 * un usuario de tipo banda en la tabla de la base de datos "banda" que se
	 * identifica a partir del email introducido como par谩metro.
	 */
	...
	/**
	 * Funci髇 que se encarga de actualiza en la BBDD el atributo informaci髇 de la banda
	 * introducida como segundo par谩metro.
	 *  
	 * @param email Cadena de caracteres que representa el email que identifica a una banda
	 * @param info Cadena de caracteres con la informaci贸n a actualizar en la BBDD sobre la banda
	 */
	...
	/**
	 * Funci髇 que se encarga de hacer una b鷖queda en la BBDD sobre las bandas que cumplen
	 * con la keyWord introducida como par醡etro.
	 *  
	 * @param keyWord Cadena de caracteres que representa el nombre de la banda introducido en la b鷖queda
